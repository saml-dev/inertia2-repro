...
const Welcome = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.user === void 0 && $$bindings.user && user !== void 0)
    $$bindings.user(user);
  return `<div class="text-3xl text-red-700" data-svelte-h="svelte-1c048gh">Hey there 👋</div> <p>${escape(a.endsWith("o"))}</p> <h1>${escape(a)}</h1> <div>user: ${escape(user)}</div>`;
});
  ...
  (page) => createInertiaApp({
    ...
    resolve: (name) => {
      const pages = /* @__PURE__ */ Object.assign({
        "./Pages/Welcome.svelte": __vite_glob_0_0
      });
